...
namespace ReallyPainfulGame
{
    public class Gloves : Equipment
    {
        ...
        {
            return new Gloves("Gants ivoire", 2, 20,50);
        }
        public static Gloves Bracers()
        {
            return new Gloves("Bracers", 3, 30,150);
        }
        public static Gloves GenjiGloves()
        {
            return new Gloves("Gants genji", 4, 40,400);
        }
        public static Gloves FireMittens()
        {
            return new Gloves("Mitaines de feu", 5, 50,1000);
        }
        public static Gloves MogGloves()
        {
            return new Gloves("Gants mog", 6, 75,1001);
        }

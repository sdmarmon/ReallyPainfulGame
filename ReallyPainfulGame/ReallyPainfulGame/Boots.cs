...
namespace ReallyPainfulGame
{
    public class Boots : Equipment
    {
        ...
        {
            return new Boots("Bottes cloutées", 1, 10);
        }
        public static Boots FightingBoots()
        {
            return new Boots("Bottes de combat", 2, 20);
        }
        public static Boots FeatherBoots()
        {
            return new Boots("Bottes en plume", 3, 30);
        }
        public static Boots Caligula()
        {
            return new Boots("Caligula", 4, 40);
        }
        public static Boots NinjaTabi()
        {
            return new Boots("Tabi ninja", 5, 50);
        }
        public static Boots SevenLeagueBoots()
        {
            return new Boots("Bottes de 7 lieues", 6, 75);
        }
